...
Everything in [`../detections/detection-catalog.csv`](../source-libraries/protocol-ndr-catalog.csv) names the log source it needs; cross-check against what you have to find your gaps.
