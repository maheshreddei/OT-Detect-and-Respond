...
**20 Sigma rules** - each as an individual file under [`02-detection/sigma/ot-ics-soc`](.). Original authored deliverable preserved at `OT_ICS_SOC_Sigma_Use_Case_Library.docx` (original authored deliverable, retained in the source repository; not migrated into this program repo).
