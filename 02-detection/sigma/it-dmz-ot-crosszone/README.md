...
**27 Sigma rules** - each as an individual file under [`02-detection/sigma/it-dmz-ot-crosszone`](.). Original authored deliverable preserved at `IT_DMZ_OT_CrossZone_Sigma_Use_Case_Library.docx` (original authored deliverable, retained in the source repository; not migrated into this program repo).
