...
**20 Sigma rules** - each as an individual file under [`rules/`](rules/). Original authored deliverable preserved at [`source/Shieldworkz_Advisory_Sigma_Use_Case_Library.docx`](source/Shieldworkz_Advisory_Sigma_Use_Case_Library.docx).
