...
- **Splunk:** lookup `ot_baseline.csv` — see [`../lookups/ot_baseline.csv`](../lookups/ot_baseline.csv)
...
- **Splunk:** lookup `sif_trip_limits.csv` — see [`../lookups/sif_trip_limits.csv`](../lookups/sif_trip_limits.csv)
