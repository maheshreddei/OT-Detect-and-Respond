...
## Data required
- The same tags collected from **two independent sources** (`source` field = `hmi_historian` and `direct_opcua`) per [`docs/historian-data-model.md`](../../../../docs/historian-data-model.md)
