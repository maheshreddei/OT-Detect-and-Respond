...
- **Golden baselines**: reference controller logic/config, firmware versions, historian baselines, approved network flows. Half of OT forensics is *compare-to-known-good* — see [`../evidence/plc-controller-safe-acquisition.md`](../evidence/plc-controller-safe-acquisition.md).
...
- The step-by-step procedure: [`../sop/universal-investigation-sop.md`](../sop/universal-investigation-sop.md)
