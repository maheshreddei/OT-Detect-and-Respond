...
Every artifact carries an unbroken record of who held it, from collection to disposition. Any gap can invalidate it. Use [`../templates/chain-of-custody-form.md`](../templates/chain-of-custody-form.md) and [`../templates/evidence-collection-log.md`](../templates/evidence-collection-log.md).
